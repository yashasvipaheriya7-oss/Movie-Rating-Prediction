...
st.markdown("""
    ...
    /* ============================================================
       ...
       Forces white background and black text on ALL input types.
       Targets both Streamlit's BaseWeb components and raw inputs.
    ============================================================ */
    ...
    /* Force visible text — -webkit-text-fill-color is required for Chrome/Safari */
    input,
    input[type="text"],
    input[type="email"],
