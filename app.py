...
if not st.session_state['auth']:
    ...
    st.markdown("""
    <style>
    /* Netflix movie poster grid background with dark overlay */
    [data-testid="stAppViewContainer"] {
        background-image:
            linear-gradient(rgba(0,0,0,0.72), rgba(0,0,0,0.72)),
            url('https://assets.nflxext.com/ffe/siteui/vlv3/9d3533b2-0e5e-449c-82f4-f437f3f40bbf/web/IN-en-20250317-TRIFECTA-perspective_4db89702-e8e0-4c08-b74e-43a0eb8e12e4_large.jpg');
    ...
    div[data-testid="stButton"] > button:hover {
        ...
        box-shadow: 0 8px 24px rgba(0,255,204,0.4) !important;
    }
    /* Checkbox styling */
    .stCheckbox label p { color: rgba(255,255,255,0.8) !important; font-size: 14px !important; }
    </style>
    """, unsafe_allow_html=True)
    ...
    with col:
        ...
        <div style="
            ...
            margin-bottom: 0;
        ">
            <h2 style="color:#FFFFFF; font-size:30px; font-weight:800; margin:0 0 22px 0;">Sign In</h2>
        </div>
        """, unsafe_allow_html=True)
        ...
        with col_help:
            st.markdown(
                "<p style='text-align:right; color:#FFFFFF; font-size:14px; "
                "margin-top:6px;'>Need help?</p>",
                unsafe_allow_html=True
            )
        ...
        st.markdown(
            ...
            "New to Cine Predict? "
            "<strong style='color:#FFFFFF;'>Sign up now.</strong></p>",
            unsafe_allow_html=True
        )
